    ...
    jenisWakaf: [
        {
            ...
            penerangan:
                'Wakaf berkuat kuasa sebaik sahaja dokumen ini ditandatangani, semasa masih hidup. ' +
                'Harta terus keluar daripada milik peribadi dari tarikh itu. TIDAK tertakluk had 1/3 pusaka ' +
                '(sebab bukan wasiat) dan TIDAK boleh ditarik balik. Sesuai jika mahu kepastian penuh ' +
        ...
        },
        {
            ...
            penerangan:
                'Wakaf hanya berkuat kuasa selepas meninggal dunia. Dari segi hukum ia dianggap sebagai ' +
                'wasiat, maka TERTAKLUK had satu pertiga (1/3) nilai bersih pusaka dan memerlukan ' +
                'persetujuan waris-waris yang sah jika penerima manfaat turut layak menerima Faraid. Sesuai jika ' +
                'mahu terus mengawal/menikmati harta tersebut semasa hayat.',
        },
    ],
    jenisHartaWakaf: [
        {
            ...
            penerangan:
                ...
                'menjadi pemegang amanah rasmi ke atas saham tersebut. PERHATIAN: jika syarikat turut ada ' +
        ...
        },
        {
            ...
            penerangan:
                ...
                'disalurkan kepada zurriah selama-lamanya sebagai wakaf. Pilihan ini serasi sepenuhnya dengan ' +
...
// EXPORT UNTUK KEGUNAAN BROWSER FRONTEND SAHAJA (TANPA MODULE.EXPORTS)
