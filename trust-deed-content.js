...
<div class="a4-page p-[18mm]" style="font-family:'Times New Roman', serif; font-size:14px; line-height:1.6; text-align:justify; color:#222;">
    ...
    <table width="100%" style="margin-bottom:30px; border-collapse:collapse;">
        ...
        <tr valign="top">
            <td width="40">B.</td>
            <td style="padding-bottom:10px;">Bagi memastikan kelangsungan perniagaan dan melindungi kepentingan legasi pewarisan, Pembuat Amanah berhasrat untuk mewujudkan satu ikatan amanah ke atas Saham Amanah tersebut berserta apa-apa hasil, dividen, atau pampasan kewangan (Takaful Keyman) yang terbit daripadanya, untuk diuruskan oleh Pemegang Amanah tertakluk kepada terma-terma di bawah.</td>
        </tr>
        <tr valign="top">
            <td width="40">C.</td>
            <td style="padding-bottom:10px;">Pemegang Amanah dengan ini bersetuju untuk menerima pelantikan tersebut dan bertindak sebagai pemegang amanah yang sah mengikut peruntukan Akta Pemegang Amanah 1949 dan/atau prinsip Syariah yang terpakai.</td>
        </tr>
    </table>
...
<div class="a4-page p-[18mm]" style="font-family:'Times New Roman', serif; font-size:14px; line-height:1.6; text-align:justify; color:#222;">
    ...
    <p style="font-weight:bold; margin-bottom:20px; padding:10px; background-color:#f3f4f6;">
    ...
    <table width="100%" style="margin-bottom:15px; border-collapse:collapse;">
        <tr valign="top">
            <td width="30">3.1</td>
            <td style="padding-bottom:8px; text-align:justify;">Tertakluk kepada Akta Pemegang Amanah 1949, Pemegang Amanah diberi kuasa mutlak untuk memindah milik saham, menandatangani resolusi syarikat mewakili saham amanah, memfailkan tuntutan pampasan Takaful, dan mencairkan aset (jika diarahkan melalui Fasal 2) tanpa perlu merujuk kepada Mahkamah atau waris Faraid.</td>
        </tr>
        <tr valign="top">
            <td width="30">3.2</td>
...
<div class="a4-page p-[18mm]" style="font-family:'Times New Roman', serif; font-size:14px; line-height:1.6; text-align:justify; color:#222;">
    ...
    <table width="100%" style="margin-bottom:15px; border-collapse:collapse;">
        <tr valign="top">
            <td width="30">4.1</td>
            <td style="padding-bottom:8px; text-align:justify;">Pemegang Amanah (terutamanya jika Syarikat Amanah) berhak untuk menuntut dan dibayar fi pentadbiran yang munasabah daripada dana atau hasil jualan Saham Amanah mengikut jadual fi (fee schedule) rasmi mereka pada waktu pentadbiran.</td>
        </tr>
        <tr valign="top">
            <td width="30">4.2</td>
